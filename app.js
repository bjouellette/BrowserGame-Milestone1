...
var trivia = {
    ...
    options: {
        q1: ['5', '10', '15', '20'],
        q2: ['30 Days', '60 Days', '90 Days', 'Only Part Time Employees get benefits'],
        q3: ['$1000', '$500', 'The Cost of the Damage', 'Nothing'],
        q4: ['Christmas', 'Easter', 'Labor Day', 'Memorial Day'],
        q5: ['Paycor', 'Podium', 'KDealer', 'Global Connect'],
